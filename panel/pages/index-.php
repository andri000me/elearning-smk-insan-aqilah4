...
header("Location: logout.php");
	...
	elseif($_REQUEST['modul']=="info_skul"){$bread = "<font color=#F70505>Identitas Sekolah </font>| Update Data Sekolah";}		
	...
	elseif($_REQUEST['modul']=="daftar_soal"){$bread = "<font color=#F70505>Bank Soal </font>| Aktivasi, Edit & Hapus";}	
	...
	elseif($_REQUEST['modul']=="data_user"){$bread = "<font color=#F70505>Manajemen User </font>| Administrasi Administrator & Guru";}
...
<div id="headtop"  style="width:98%; margin:0px 15px 15px 15px; height:60px; background-color:#fffefb; 
	border-bottom-color:#e4e4e2; font-size:14px; padding:15px; text-align:center"><span style="color: #ff0000;"><?php echo strtoupper($skull); ?> </span>
</div>
