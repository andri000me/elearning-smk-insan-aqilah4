...
?>
    ...
    <tr>
    <td colspan="2" align="center"><font size="3"><b>UJIAN SEKOLAH BERBASIS ANDROID (USBK)</b></font></td>
    </tr>
    <tr>
  ...
  <?php echo "$xkab"; ?> telah diselenggarakan Ujian Sekolah Berbasis ANDROID (USBA) untuk mata pelajaran <?php echo $rs2; ?> dari pukul 
