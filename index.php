...
<nav class="navbar navbar-default" style="background-color:#F7FACD">
	<div class="container-fluid">
		...
		<div class="navbar-header" >
			...
			<a class="navbar-brand" ><span style="color:#0100EB"><b>CBT-Aqilah 4</span><span style="color:#EB1707"></b></span></a>
		</div>
...
<a href="./e-learning/app/index.php"><button type="button" class="btn btn-success btn-small">&nbsp;&nbsp;&nbsp;&nbsp; e- &nbsp;&nbsp;&nbsp;&nbsp;</button></a><br>
</center>
<?php } ?>
<br>
<br>
...
<div class="group" style="background-color:<?php echo $warna; ?>;">
    <div  style="background-color:<?php echo $warna; ?>; padding:7px; font-size:12px">
        <center><b><span style="color: #ff0000;"><?php echo strtoupper("$skull"); ?> </span></b> <br> <span style="color: #1B06CF;">COMPUTER BASED TEST</span></center>
    </div>
</footer>
