...
$logo ="logo.gif";
$warna = "#0AF713";
if  (file_exists('./config/madipo_cbt.sql')){$footer = "SMK Insan Aqilah 4";}else{
$footer = "@bBrother.91";}
}
?>
<!DOCTYPE html>
...
<div class="group" style="background-color:<?php echo $warna; ?>;">
    <div  style="background-color:<?php echo $warna; ?>; padding:7px; font-size:12px">
        <p><b><span style="color: #ff0000;"><?php echo strtoupper("$footer"); ?> </span></b><br> <span style="color: #1B06CF;">COMPUTER BASED TEST</span></p>
    </div>
</footer>
